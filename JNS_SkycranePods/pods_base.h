...
class JNS_SkycranePod_Ammo: Land_Pod_Heli_Transport_04_ammo_F {
  ...
  hiddenSelectionsTextures[] = {"\A3\Air_F_Heli\Heli_Transport_04\Data\Heli_Transport_04_Pod_Ext01_black_CO.paa",
...
class JNS_SkycranePod_Bench: Land_Pod_Heli_Transport_04_bench_F {
  ...
  hiddenSelectionsTextures[] = {"\A3\Air_F_Heli\Heli_Transport_04\Data\Heli_Transport_04_bench_black_CO.paa"};
};
...
class JNS_SkycranePod_Fuel: Land_Pod_Heli_Transport_04_fuel_F {
  ...
  hiddenSelections[] = {"Camo_1"};
  hiddenSelectionsTextures[] = {"\A3\Air_F_Heli\Heli_Transport_04\Data\Heli_Transport_04_fuel_black_CO.paa"};
};
