...
// Helicopters
  ...
  class JNS_Skycrane_BLU_Green: JNS_Skycrane_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Ammo_BLU_Green: JNS_Skycrane_Ammo_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Bench_BLU_Green: JNS_Skycrane_Bench_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Cargo_BLU_Green: JNS_Skycrane_Cargo_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Transport_BLU_Green: JNS_Skycrane_Transport_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Fuel_BLU_Green: JNS_Skycrane_Fuel_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Medical_BLU_Green: JNS_Skycrane_Medical_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Repair_BLU_Green: JNS_Skycrane_Repair_BLU_Base {
    MACRO_CONFIG
...
// Pods
  ...
  class JNS_Skycrane_Pod_Ammo_BLU_Green: JNS_Skycrane_Pod_Ammo_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Bench_BLU_Green: JNS_Skycrane_Pod_Bench_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Cargo_BLU_Green: JNS_Skycrane_Pod_Cargo_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Transport_BLU_Green: JNS_Skycrane_Pod_Transport_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Fuel_BLU_Green: JNS_Skycrane_Pod_Fuel_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Medical_BLU_Green: JNS_Skycrane_Pod_Medical_BLU_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Repair_BLU_Green: JNS_Skycrane_Pod_Repair_BLU_Base {
    MACRO_CONFIG
