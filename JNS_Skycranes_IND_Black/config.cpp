...
// Helicopters
  ...
  class JNS_Skycrane_IND_Black: JNS_Skycrane_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Ammo_IND_Black: JNS_Skycrane_Ammo_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Bench_IND_Black: JNS_Skycrane_Bench_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Cargo_IND_Black: JNS_Skycrane_Cargo_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Transport_IND_Black: JNS_Skycrane_Transport_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Fuel_IND_Black: JNS_Skycrane_Fuel_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Medical_IND_Black: JNS_Skycrane_Medical_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Repair_IND_Black: JNS_Skycrane_Repair_IND_Base {
    MACRO_CONFIG
...
// Pods
  ...
  class JNS_Skycrane_Pod_Ammo_IND_Black: JNS_Skycrane_Pod_Ammo_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Bench_IND_Black: JNS_Skycrane_Pod_Bench_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Cargo_IND_Black: JNS_Skycrane_Pod_Cargo_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Transport_IND_Black: JNS_Skycrane_Pod_Transport_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Fuel_IND_Black: JNS_Skycrane_Pod_Fuel_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Medical_IND_Black: JNS_Skycrane_Pod_Medical_IND_Base {
    MACRO_CONFIG
  ...
  class JNS_Skycrane_Pod_Repair_IND_Black: JNS_Skycrane_Pod_Repair_IND_Base {
    MACRO_CONFIG
